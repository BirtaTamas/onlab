...
- tick `18451`, seconds `30.00`, LSTM `0.1181`, delta `-0.3081`
...
- tick `18035`, seconds `23.50`, LSTM `0.3749`, delta `-0.0807`
- tick `17267`, seconds `11.50`, LSTM `0.2777`, delta `-0.0801`
- tick `18419`, seconds `29.50`, LSTM `0.4262`, delta `+0.0689`
...
- `lag_11__T1__flash_duration`: coefficient `-0.000800` (lowers CT win probability)
...
- `lag_00__kill_diff_last_3s`: coefficient `0.001204` (raises CT win probability)
- `lag_05__T_bomb_zone_count`: coefficient `-0.001182` (lowers CT win probability)
- `lag_00__T_kills_last_3s`: coefficient `-0.001180` (lowers CT win probability)
...
### tick `18451`, seconds `30.00`, LSTM delta `-0.3081`

Top all feature movements:
- `lag_04__T_place_HUT`: contribution `-0.022900`
- `lag_07__CT_place_SECRET`: contribution `-0.011450`
- `lag_00__T_shots_fired_sum`: contribution `-0.009613`
- `lag_09__T_place_HUT`: contribution `-0.009244`
- `lag_13__T_place_SQUEAKY`: contribution `-0.008528`

Top utility-only movements:
- `lag_09__T2__flash_duration`: contribution `-0.006387`
- `lag_09__T1__flash_duration`: contribution `-0.005744`
- `lag_09__CT4__flash_duration`: contribution `-0.004807`
...
- `lag_05__T_place_HUT`: contribution `-0.005791`
...
Top all feature movements:
- `lag_00__T_place_HUT`: contribution `+0.015476`
- `lag_13__T_place_SQUEAKY`: contribution `+0.008528`
- `lag_09__CT_place_HEAVEN`: contribution `+0.007479`
- `lag_14__T_place_HUT`: contribution `+0.007375`
- `lag_08__T_place_HUT`: contribution `+0.006094`

Top utility-only movements:
- `lag_07__T2__flash_duration`: contribution `+0.004490`

### tick `18131`, seconds `25.00`, LSTM delta `+0.1007`

Top all feature movements:
- `lag_00__T_place_HUT`: contribution `+0.015476`
- `lag_00__T_shots_fired_sum`: contribution `+0.008739`
...
- `lag_02__T_shots_fired_sum`: contribution `-0.004109`
