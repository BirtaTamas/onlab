...
- tick `53631`, seconds `78.00`, LSTM `0.1059`, delta `-0.2134`
- tick `50975`, seconds `36.50`, LSTM `0.2736`, delta `-0.1955`
- tick `53567`, seconds `77.00`, LSTM `0.3635`, delta `-0.1043`
...
- `lag_06__CT3__duck_amount`: coefficient `-0.001436`, |coef| `0.001436`
- `lag_00__CT1__duck_amount`: coefficient `-0.001347`, |coef| `0.001347`
...
- `lag_00__CT_B_site_active_smokes`: coefficient `0.000613` (raises CT win probability)
...
- `lag_06__CT3__duck_amount`: coefficient `-0.001436` (lowers CT win probability)
- `lag_00__CT1__duck_amount`: coefficient `-0.001347` (lowers CT win probability)
...
- `lag_09__T_place_HELL`: contribution `+0.054439`
- `lag_00__T_place_HELL`: contribution `+0.053287`
- `lag_13__T_place_HELL`: contribution `+0.032555`
- `lag_14__T_place_ADMIN`: contribution `+0.018317`
- `lag_07__T_place_HELL`: contribution `+0.014859`

Top utility-only movements:
- No utility movement among the top local contributors.

### tick `53631`, seconds `78.00`, LSTM delta `-0.2134`

Top all feature movements:
- `lag_09__T_place_HELL`: contribution `-0.054439`
- `lag_02__T_place_HELL`: contribution `-0.034715`
- `lag_00__T_place_CONTROL`: contribution `-0.006407`
- `lag_00__T_place_TROPHY`: contribution `-0.006290`
...
Top all feature movements:
- `lag_14__CT_utility_damage_last_5s`: contribution `-0.017302`
- `lag_14__utility_damage_diff_last_5s`: contribution `-0.011475`
- `lag_08__CT_place_VENTS`: contribution `-0.011024`
- `lag_06__T_place_TROPHY`: contribution `-0.006073`
- `lag_00__T_kills_last_3s`: contribution `-0.006061`

Top utility-only movements:
- `lag_14__CT_utility_damage_last_5s`: contribution `-0.017302`
- `lag_14__utility_damage_diff_last_5s`: contribution `-0.011475`
- `lag_14__CT2__flash_duration`: contribution `-0.006037`
- `lag_15__T1__flash_duration`: contribution `-0.004459`

### tick `53567`, seconds `77.00`, LSTM delta `-0.1043`

Top all feature movements:
- `lag_00__T_place_HELL`: contribution `-0.053287`
- `lag_07__T_place_HELL`: contribution `+0.014859`
- `lag_14__T_place_HELL`: contribution `-0.010679`
- `lag_06__CT3__duck_amount`: contribution `+0.005342`
- `lag_05__T_place_TROPHY`: contribution `-0.005140`
...
Top all feature movements:
- `lag_15__CT_place_MINI`: contribution `-0.007307`
- `lag_00__T_kills_last_3s`: contribution `-0.006061`
- `lag_06__CT3__duck_amount`: contribution `-0.005342`
- `lag_00__kill_diff_last_3s`: contribution `-0.005093`
- `lag_00__CT1__duck_amount`: contribution `-0.004734`
