...
- tick `43706`, seconds `62.00`, LSTM `0.7514`, delta `+0.2366`
- tick `43354`, seconds `56.50`, LSTM `0.4284`, delta `+0.2232`
- tick `40730`, seconds `15.50`, LSTM `0.2103`, delta `-0.2025`
- tick `43770`, seconds `63.00`, LSTM `0.9398`, delta `+0.1903`
- tick `42554`, seconds `44.00`, LSTM `0.1917`, delta `+0.0754`
...
- tick `42682`, seconds `46.00`, LSTM `0.2720`, delta `+0.0518`
- tick `40794`, seconds `16.50`, LSTM `0.1028`, delta `-0.0496`

## Top 15 local ridge features

- `lag_05__CT_place_TUNNEL`: coefficient `0.002684`, |coef| `0.002684`
...
- `lag_00__CT_place_OUTSIDELONG`: coefficient `0.001882`, |coef| `0.001882`
- `lag_01__T1__is_scoped`: coefficient `0.001777`, |coef| `0.001777`
...
- `lag_05__CT_place_TUNNEL`: coefficient `0.002684` (raises CT win probability)
...
- `lag_00__CT_place_OUTSIDELONG`: coefficient `0.001882` (raises CT win probability)
- `lag_01__T1__is_scoped`: coefficient `0.001777` (raises CT win probability)
...
- `lag_09__CT_place_TUNNEL`: contribution `+0.040033`
- `lag_04__CT_place_BRIDGE`: contribution `+0.024224`
- `lag_09__CT_place_MAIN`: contribution `+0.010703`
- `lag_01__T1__is_scoped`: contribution `+0.010150`
- `lag_07__CT_place_MAIN`: contribution `+0.007057`

Top utility-only movements:
- `lag_01__T_B_site_active_infernos`: contribution `+0.003489`
- `lag_12__T_B_site_active_infernos`: contribution `+0.002398`

### tick `43354`, seconds `56.50`, LSTM delta `+0.2232`

Top all feature movements:
- `lag_05__CT_place_TUNNEL`: contribution `+0.043107`
- `lag_14__CT_place_BRIDGE`: contribution `+0.024776`
- `lag_03__CT_place_FOUNTAIN`: contribution `+0.017853`
- `lag_08__CT_place_FOUNTAIN`: contribution `+0.007536`
...
Top all feature movements:
- `lag_01__CT_place_OUTSIDELONG`: contribution `-0.048310`
- `lag_00__CT_place_OUTSIDELONG`: contribution `-0.019093`
- `lag_10__T_shots_fired_sum`: contribution `-0.006318`
- `lag_10__T_place_STREET`: contribution `-0.006313`
- `lag_00__T1__is_scoped`: contribution `-0.005980`

Top utility-only movements:
- `lag_01__T1__flash_duration`: contribution `-0.003885`

### tick `43770`, seconds `63.00`, LSTM delta `+0.1903`

Top all feature movements:
- `lag_06__CT_place_BRIDGE`: contribution `+0.019207`
- `lag_11__CT_place_TUNNEL`: contribution `+0.017356`
- `lag_09__CT_place_MAIN`: contribution `+0.010703`
- `lag_00__CT_place_CTSIDEUPPER`: contribution `+0.007388`
- `lag_10__CT_place_MAIN`: contribution `+0.005557`
...
Top all feature movements:
- `lag_06__CT_place_FOUNTAIN`: contribution `+0.008054`
- `lag_00__T1__is_scoped`: contribution `-0.005980`
- `lag_00__CT_kills_last_3s`: contribution `+0.004591`
- `lag_00__kill_diff_last_3s`: contribution `+0.004132`
- `lag_04__T_shots_fired_sum`: contribution `+0.003899`

Top utility-only movements:
- `lag_07__CT5__flash_duration`: contribution `+0.002688`
